...
class Sky {
    ...
    createDome() {
        ...
        for (var i = 0; i < gridSize; i++) {
            for (var j = 0; j < gridSize; j++) {
                ...
                plane.lookAt(window.camera.position.x, window.camera.position.y, window.camera.position.z);
    ...
    for (var i = 0; i < this.sky.length; i++) {
        ...
        } else if (this.sun.position.y > 0 && this.sun.position.y <= this.sceneRadius * 0.3) {
