...
class Water extends Mesh {
	...
	constructor( geometry, options = {} ) {
		...
		const normalMap0 = options.normalMap0 || textureLoader.load( '/images/waternormals.jpg' );
		const normalMap1 = options.normalMap1 || textureLoader.load( '/images/waternormals.jpg');
